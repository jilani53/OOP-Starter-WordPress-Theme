 ...
 *
 * With complex themes/plugins, there are many cases where multiple copies of
...
namespace STARTER_THEME\Inc\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the `starter_theme_singleton_init_{$called_class}` hook to execute code
			 */
			do_action( sprintf( 'starter_theme_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
